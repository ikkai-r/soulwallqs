...
export default function DemoPage({ onValidationChange, responses, setResponses }) {
        ...
        <form className="mx-auto w-1/2 flex flex-col gap-5">
          ...
          <div className="w-full">
             <label htmlFor="hand" className="block mb-2 text-sm font-medium text-gray-900 ">Lefthanded or Righthanded?</label>
              <select id="hand" name="hand" value={responses.hand || ''} onChange={handleChange} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
          ...
          <div className="w-full">
            <label htmlFor="VRf"  className="block mb-2 text-sm font-medium text-gray-900 ">Have you used VR before?</label>
              <select id="VRf" name="VRf" value={responses.VRf || ''} onChange={handleChange}  className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
